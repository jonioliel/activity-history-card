 ...
 */
const ne = globalThis, Ae = ne.ShadowRoot && (ne.ShadyCSS === void 0 || ne.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Ce = Symbol(), Pe = /* @__PURE__ */ new WeakMap();
let _t = class {
  constructor(e, a, i) {
  ...
  get styleSheet() {
    ...
    if (Ae && e === void 0) {
      ...
      i && (e = Pe.get(a)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), i && Pe.set(a, e));
    }
    return e;
  }
  toString() {
...
const aa = (t) => new _t(typeof t == "string" ? t : t + "", void 0, Ce), gt = (t, ...e) => {
  const a = t.length === 1 ? t[0] : e.reduce((i, n, r) => i + ((s) => {
    if (s._$cssResult$ === !0) return s.cssText;
    if (typeof s == "number") return s;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + s + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(n) + t[r + 1], t[0]);
  return new _t(a, t, Ce);
}, ia = (t, e) => {
  if (Ae) t.adoptedStyleSheets = e.map((a) => a instanceof CSSStyleSheet ? a : a.styleSheet);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: na, defineProperty: ra, getOwnPropertyDescriptor: sa, getOwnPropertyNames: oa, getOwnPropertySymbols: ca, getPrototypeOf: la } = Object, ce = globalThis, De = ce.trustedTypes, da = De ? De.emptyScript : "", ha = ce.reactiveElementPolyfillSupport, X = (t, e) => t, ye = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? da : null;
      break;
  ...
  return a;
} }, mt = (t, e) => !na(t, e), Le = { attribute: !0, type: String, converter: ye, reflect: !1, useDefault: !1, hasChanged: mt };
...
let O = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, a, i) {
    const { get: n, set: r } = sa(this.prototype, e) ?? { get() {
      return this[a];
    }, set(s) {
      this[a] = s;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(X("properties"))) {
      const a = this.properties, i = [...oa(a), ...ca(a)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const n of i) a.unshift(He(n));
  ...
  _$ET(e, a) {
    ...
    if (n !== void 0 && i.reflect === !0) {
      const r = (i.converter?.toAttribute !== void 0 ? i.converter : ye).toAttribute(a, i.type);
  ...
  _$AK(e, a) {
    ...
    if (n !== void 0 && this._$Em !== n) {
      const r = i.getPropertyOptions(n), s = typeof r.converter == "function" ? { fromAttribute: r.converter } : r.converter?.fromAttribute !== void 0 ? r.converter : ye;
      this._$Em = n;
  ...
  requestUpdate(e, a, i, n = !1, r) {
    if (e !== void 0) {
      ...
      if (n === !1 && (r = this[e]), i ??= s.getPropertyOptions(e), !((i.hasChanged ?? mt)(r, a) || i.useDefault && i.reflect && r === this._$Ej?.get(e) && !this.hasAttribute(s._$Eu(e, i)))) return;
      this.C(e, a, i);
    }
...
O.elementStyles = [], O.shadowRootOptions = { mode: "open" }, O[X("elementProperties")] = /* @__PURE__ */ new Map(), O[X("finalized")] = /* @__PURE__ */ new Map(), ha?.({ ReactiveElement: O }), (ce.reactiveElementVersions ??= []).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Me = globalThis, Ne = (t) => t, se = Me.trustedTypes, Fe = se ? se.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, bt = "$lit$", T = `lit$${Math.random().toFixed(9).slice(2)}$`, vt = "?" + T, pa = `<${vt}>`, L = document, J = () => L.createComment(""), Z = (t) => t === null || typeof t != "object" && typeof t != "function", Re = Array.isArray, ua = (t) => Re(t) || typeof t?.[Symbol.iterator] == "function", he = `[ 	
\f\r]`, Y = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Be = /-->/g, Oe = />/g, P = RegExp(`>|${he}(?:([^\\s"'>=/]+)(${he}*=${he}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), je = /'/g, Ge = /"/g, ft = /^(?:script|style|textarea|title)$/i, _a = (t) => (e, ...a) => ({ _$litType$: t, strings: e, values: a }), h = _a(1), V = Symbol.for("lit-noChange"), _ = Symbol.for("lit-nothing"), Ue = /* @__PURE__ */ new WeakMap(), D = L.createTreeWalker(L, 129);
function yt(t, e) {
...
const ga = (t, e) => {
  ...
  let n, r = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", s = Y;
  for (let c = 0; c < a; c++) {
    const o = t[c];
    let l, d, p = -1, u = 0;
    for (; u < o.length && (s.lastIndex = u, d = s.exec(o), d !== null); ) u = s.lastIndex, s === Y ? d[1] === "!--" ? s = Be : d[1] !== void 0 ? s = Oe : d[2] !== void 0 ? (ft.test(d[2]) && (n = RegExp("</" + d[2], "g")), s = P) : d[3] !== void 0 && (s = P) : s === P ? d[0] === ">" ? (s = n ?? Y, p = -1) : d[1] === void 0 ? p = -2 : (p = s.lastIndex - d[2].length, l = d[1], s = d[3] === void 0 ? P : d[3] === '"' ? Ge : je) : s === Ge || s === je ? s = P : s === Be || s === Oe ? s = Y : (s = P, n = void 0);
    const g = s === P && t[c + 1].startsWith("/>") ? " " : "";
    r += s === Y ? o + pa : p >= 0 ? (i.push(l), o.slice(0, p) + bt + o.slice(p) + T + g) : o + T + (p === -2 ? c : g);
  }
  return [yt(t, r + (t[a] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), i];
};
class Q {
  constructor({ strings: e, _$litType$: a }, i) {
    ...
    this.parts = [];
    let r = 0, s = 0;
    const c = e.length - 1, o = this.parts, [l, d] = ga(e, a);
    if (this.el = Q.createElement(l, i), D.currentNode = this.el.content, a === 2 || a === 3) {
      const p = this.el.content.firstChild;
      p.replaceWith(...p.childNodes);
    }
    for (; (n = D.nextNode()) !== null && o.length < c; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) for (const p of n.getAttributeNames()) if (p.endsWith(bt)) {
          const u = d[s++], g = n.getAttribute(p).split(T), v = /([.?@])?(.*)/.exec(u);
          o.push({ type: 1, index: r, name: v[2], strings: g, ctor: v[1] === "." ? ba : v[1] === "?" ? va : v[1] === "@" ? fa : le }), n.removeAttribute(p);
        ...
        if (ft.test(n.tagName)) {
          ...
          if (u > 0) {
            ...
            for (let g = 0; g < u; g++) n.append(p[g], J()), D.nextNode(), o.push({ type: 2, index: ++r });
            n.append(p[u], J());
          }
        }
      } else if (n.nodeType === 8) if (n.data === vt) o.push({ type: 2, index: r });
      else {
        let p = -1;
...
function q(t, e, a = t, i) {
  if (e === V) return e;
  let n = i !== void 0 ? a._$Co?.[i] : a._$Cl;
  const r = Z(e) ? void 0 : e._$litDirective$;
  return n?.constructor !== r && (n?._$AO?.(!1), r === void 0 ? n = void 0 : (n = new r(t), n._$AT(t, a, i)), i !== void 0 ? (a._$Co ??= [])[i] = n : a._$Cl = n), n !== void 0 && (e = q(t, n._$AS(t, e.values), n, i)), e;
}
class ma {
  constructor(e, a) {
  ...
  u(e) {
    const { el: { content: a }, parts: i } = this._$AD, n = (e?.creationScope ?? L).importNode(a, !0);
    D.currentNode = n;
    let r = D.nextNode(), s = 0, c = 0, o = i[0];
    for (; o !== void 0; ) {
      if (s === o.index) {
        let l;
        o.type === 2 ? l = new ee(r, r.nextSibling, this, e) : o.type === 1 ? l = new o.ctor(r, o.name, o.strings, this, e) : o.type === 6 && (l = new ya(r, this, e)), this._$AV.push(l), o = i[++c];
      }
      s !== o?.index && (r = D.nextNode(), s++);
    }
    return D.currentNode = L, n;
  }
  p(e) {
    let a = 0;
...
class ee {
  ...
  _$AI(e, a = this) {
    e = q(this, e, a), Z(e) ? e === _ || e == null || e === "" ? (this._$AH !== _ && this._$AR(), this._$AH = _) : e !== this._$AH && e !== V && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : ua(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== _ && Z(this._$AH) ? this._$AA.nextSibling.data = e : this.T(L.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    const { values: a, _$litType$: i } = e, n = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = Q.createElement(yt(i.h, i.h[0]), this.options)), i);
    if (this._$AH?._$AD === n) this._$AH.p(a);
    else {
      const r = new ma(n, this), s = r.u(this.options);
      r.p(a), this.T(s), this._$AH = r;
    }
  }
  _$AC(e) {
    let a = Ue.get(e.strings);
    return a === void 0 && Ue.set(e.strings, a = new Q(e)), a;
  }
  k(e) {
    Re(this._$AH) || (this._$AH = [], this._$AR());
    const a = this._$AH;
    let i, n = 0;
    for (const r of e) n === a.length ? a.push(i = new ee(this.O(J()), this.O(J()), this, this.options)) : i = a[n], i._$AI(r), n++;
...
class le {
  ...
  _$AI(e, a = this, i, n) {
    ...
    let s = !1;
    if (r === void 0) e = q(this, e, a, 0), s = !Z(e) || e !== this._$AH && e !== V, s && (this._$AH = e);
    else {
      const c = e;
      let o, l;
      for (e = r[0], o = 0; o < r.length - 1; o++) l = q(this, c[i + o], a, o), l === V && (l = this._$AH[o]), s ||= !Z(l) || l !== this._$AH[o], l === _ ? e = _ : e !== _ && (e += (l ?? "") + r[o + 1]), this._$AH[o] = l;
    }
    s && !n && this.j(e);
  }
  j(e) {
...
const xa = Me.litHtmlPolyfillSupport;
xa?.(Q, ee), (Me.litHtmlVersions ??= []).push("3.3.3");
const wa = (t, e, a) => {
  const i = a?.renderBefore ?? e;
  let n = i._$litPart$;
  if (n === void 0) {
    const r = a?.renderBefore ?? null;
    i._$litPart$ = n = new ee(e.insertBefore(J(), r), r, void 0, a ?? {});
  }
  return n._$AI(t), n;
};
/**
...
class G extends O {
  ...
  update(e) {
    const a = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = wa(a, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
G._$litElement$ = !0, G.finalized = !0, Se.litElementHydrateSupport?.({ LitElement: G });
const ka = Se.litElementPolyfillSupport;
ka?.({ LitElement: G });
...
function xt(t, e, a) {
  const i = Ca(e, a), n = Ma(e, i), r = n.map(() => /* @__PURE__ */ new Set());
  for (const c of t)
    for (const o of c.segments)
      if (o.active)
        for (let l = 0; l < n.length; l += 1) {
          const d = n[l];
          if (!d) continue;
          const p = Ra(o, d.start, d.end);
          p <= 0 || (d.totalActiveMs += p, d.eventCount += Sa(o, d) ? 1 : 0, r[l]?.add(c.entity.entity_id));
        }
  const s = Math.max(
    1,
...
function ae(t, e, a = {}) {
  const i = a.showAll === !0 || e.activity_mode === "all", n = ja(e, i), r = e.smart_filter !== !1 && n === "meaningful" && !i, s = e.show_inactive_baselines ?? b.show_inactive_baselines, c = /* @__PURE__ */ new Map(), o = Mt(e), l = (Rt(e.min_row_active_seconds) ?? b.min_row_active_seconds) * 1e3, d = qe(e.max_rows_per_group) ?? b.max_rows_per_group, p = qe(e.max_total_rows) ?? b.max_total_rows;
  let u = 0;
  const g = [], v = [];
  for (const w of t) {
    const m = o.has(w.entity.entity_id);
    m && (u += 1);
    const y = r ? Da(w, e, l, m) : { row: w };
    y.reason ? (v.push(w), c.set(w.entity.entity_id, y.reason)) : y.row && g.push(y.row);
  }
  const k = r ? Na(g, v, c, {
  ...
  return {
    rows: k.rows,
    hiddenRows: k.hiddenRows,
    hiddenReasons: c,
    diagnostics: Ba({
      totalRows: t.length,
      visibleRows: k.rows.length,
      hiddenRows: k.hiddenRows.length,
      hiddenReasons: c,
      smartFilter: r,
      activityMode: n,
...
function Pa(t) {
  return zt(t.entity) || t.entity.domain === "switch" && At(t.entity);
}
function Ha(t, e) {
  return t.segments.filter(
    (a) => $t(a) && a.durationMs >= e
  );
}
function U(t) {
  if (!t) return "";
...
function Da(t, e, a, i) {
  const n = kt(t.entity, e);
  if (!i && !n.visible)
    return { reason: n.reason ?? "technical" };
  const r = Ha(t, a);
  return r.length ? { row: La(t, r) } : i ? { row: t } : (e.hide_empty_rows ?? b.hide_empty_rows) === !1 ? { row: t } : t.segments.length ? {
    reason: t.segments.some(
      (c) => $t(c) && c.durationMs < a
...
function La(t, e) {
  ...
  return {
    ...
    totalActiveMs: a,
    eventCount: e.length,
    currentCategory: i && !wt.has(i) ? i : void 0
  };
}
function $t(t) {
  return t.active && !wt.has(t.category);
}
function Na(t, e, a, i) {
  const n = t.filter(
  ...
  for (const p of pe(r)) {
    const u = Fa(p, i.groupBy), g = s.get(u) ?? [];
...
function pe(t) {
  return [...t].sort(
    (e, a) => Number(Ve(a)) - Number(Ve(e)) || a.totalActiveMs - e.totalActiveMs || a.eventCount - e.eventCount || e.entity.name.localeCompare(a.entity.name, "he")
  );
}
function Ve(t) {
  const e = Date.now();
...
function zt(t) {
  const e = Oa(t, !0);
  return Ia.some((a) => Ct(e, a));
}
function At(t) {
  const e = oe(t.name), a = oe(t.entity_id), i = `${e} ${a}`;
  return t.domain === "switch" && Ea.has(e) ? !0 : Ta.some((n) => Ct(i, n));
}
function Oa(t, e = !1) {
  return [
    t.entity_id,
    ...
    ...t.labels ?? []
  ].filter(Boolean).map((a) => oe(String(a))).join(" ");
}
function Ct(t, e) {
  const a = oe(e);
  if (!a) return !1;
...
const Ga = ["ar", "fa", "he", "iw", "ur"];
function K(t) {
  return t.includes(".") ? t.split(".")[0] ?? t : t;
}
function ue(t, e = /* @__PURE__ */ new Date()) {
  if (t.start_time) {
...
const Wa = 0.5;
function Tt(t, e) {
  const a = e.start.getTime(), i = e.end.getTime(), n = Math.max(1, i - a), r = Math.max(t.start.getTime(), a), s = Math.min(t.end.getTime(), i), c = Math.min(Math.max(r, a), i), o = Math.min(Math.max(s, a), i), l = Math.max(0, o - c), d = Ke((c - a) / n * 100), p = Ke(l / n * 100);
  return {
    leftPct: d,
    widthPct: p,
    minVisible: t.active && l > 0 && p < Wa
  };
}
function Ke(t) {
...
function Ja(t, e, a = !1) {
  const i = a ? () => !0 : (c) => te(c), n = t.map((c) => ({
    ...c,
    rows: c.rows.filter(i)
  })).filter((c) => c.rows.length > 0), r = n.reduce(
    (c, o) => c + o.rows.length,
    0
  ), s = e.reduce(
    (c, o) => c + o.rows.filter(i).length,
    0
  );
  return {
    groups: n,
    totalRowCount: s,
    visibleRowCount: r,
    hiddenRowCount: Math.max(0, s - r)
  };
}
function We(t, e, a, i, n = {}) {
  const r = n.selectedGroups ? Ja(
    n.selectedGroups,
    t,
    n.includeInactiveRows
  ) : Xa(t, a), s = r.groups.flatMap((y) => y.rows), c = t.flatMap((y) => y.rows).filter(te), o = n.inventoryRows ?? t.flatMap((y) => y.rows), l = ai(
    o,
    a,
    n.groupBy
  ), d = Qa(
    ...
    l,
    e
  ), p = i?.totalRows ?? r.totalRowCount, u = Math.max(
    0,
    i?.hiddenRows ?? 0,
    r.hiddenRowCount,
    p - r.visibleRowCount
    ...
    (y, C) => y + C.totalActiveMs,
    0
  ), k = s.reduce(
    (y, C) => y + C.eventCount,
    0
  ), w = d.reduce(
    (y, C) => y + C.inventoryItemCount,
    0
  ), m = n.selectedAreas?.length === 1 || d.length === 1 && n.groupBy !== "domain";
  return {
    range: e,
    totalRowsBeforeCuration: p,
    visibleRowsCount: r.visibleRowCount,
    hiddenRowsCount: u,
    hiddenReasonSummary: U(i),
    totalVisibleActiveMs: v,
    visibleEventCount: k,
    activeNowCount: s.filter(E).length,
...
function Qa(t, e, a, i) {
  ...
  return [
    ...
    const l = r.get(o), d = n.get(o), p = s.get(o), u = d?.rows.filter(te) ?? [];
    return {
      id: o,
      totalActiveMs: l?.totalActiveMs ?? u.reduce((g, v) => g + v.totalActiveMs, 0),
      activityCount: l?.rows.length ?? u.length,
      inventoryCount: p?.rows.length ?? 0,
      title: l?.title ?? d?.title ?? p?.title ?? o
    };
...
function ei(t, e, a, i) {
  const n = t ?? e, r = e?.rows ?? t?.rows ?? [], s = (t?.rows ?? []).map(
    (u) => ti(u, i)
  ), c = (a?.rows ?? []).map(ii).sort(si), o = r.filter(te), l = o.length ? o : t?.rows ?? [], d = l.reduce(
    (u, g) => u + g.totalActiveMs,
    0
  ), p = l.reduce(
    (u, g) => u + g.eventCount,
    0
  ...
  return {
    ...
    totalEntityCount: c.length,
    visibleActivityRowCount: o.length || s.length,
    inventoryItemCount: c.length,
    ...
    totalActiveMs: d,
    eventCount: p,
    activeNowCount: l.filter(E).length,
    aggregateSegments: ni(
      l,
      i,
...
function ti(t, e) {
  const a = t.segments.map((i, n) => ({ segment: i, sourceIndex: n })).filter((i) => i.segment.active).map(
    ({ segment: i, sourceIndex: n }) => It(
      i,
      e,
      `${t.entity.name} · ${A[i.category]} · ${f(
        i.start
      )} עד ${f(i.end)} · ${x(i.durationMs)}`,
      n
    )
  ).filter(
    (i) => !!(i && i.widthPct > 0)
...
function ai(t, e, a = "area") {
  ...
  for (const s of t) {
    if (i.length && !i.includes(s.entity.domain) || !n && s.totalActiveMs <= 0 && !E(s) || !kt(s.entity, e).visible) continue;
    const o = oi(s.entity, a), l = r.get(o) ?? {
      id: o,
      title: ci(s.entity, a),
      icon: li(s.entity, a),
      area: s.entity.area,
  ...
  return [...r.values()].map((s) => ({
    ...s,
    rows: [...s.rows].sort(
      (c, o) => Number(E(o)) - Number(E(c)) || +(o.totalActiveMs > 0) - +(c.totalActiveMs > 0) || c.entity.name.localeCompare(o.entity.name, "he")
    )
  }));
}
function ii(t) {
...
function ni(t, e, a) {
  ...
  for (const r of i) {
    const s = n.at(-1);
    if (s && r.start.getTime() <= s.end.getTime() + Ya) {
      s.end = new Date(
...
function ri(t, e) {
  ...
  return {
    ...
    peakBucketLabel: c && c.totalActiveMs > 0 ? `${f(c.start)} - ${f(c.end)}` : void 0,
...
function si(t, e) {
  return Number(e.activeNow) - Number(t.activeNow) || Number(e.hadActivityInRange) - Number(t.hadActivityInRange) || xe(t.domain).localeCompare(xe(e.domain), "he") || t.name.localeCompare(e.name, "he");
}
function oi(t, e) {
  return e === "domain" ? t.domain || "other" : e === "none" || e === "entity" ? "all" : t.area || "ללא אזור";
}
function ci(t, e) {
  return e === "domain" ? xe(t.domain) : e === "none" || e === "entity" ? "כל הרכיבים" : t.area || "ללא אזור";
}
function li(t, e) {
  if (e === "domain") return _i(t.domain);
}
function di(t) {
  return t.currentCategory ? A[t.currentCategory] : t.currentState ? t.currentState : t.totalActiveMs > 0 ? "היתה פעילות" : "לא פעיל";
}
function hi(t) {
  return pi(t) ? "unavailable" : E(t) ? "active" : t.totalActiveMs > 0 ? "had_activity" : "inactive";
}
function pi(t) {
...
async function mi(t, e) {
  const a = t.entities ?? [], i = e ? await yi(e) : xi(), n = a.map(
  ...
  return {
    entities: n.filter((c) => c.entity && !c.hidden).map((c) => vi(c, t, e, i)).filter((c) => !!c).filter(
      (c) => Pt(c.labels ?? [], t, i.labels)
    ),
    diagnostics: wi(i, r, t)
  };
}
function bi(t, e, a) {
  const i = t.domains?.length ? t.domains : re, n = N(t.exclude_domains ?? []), r = N(t.areas ?? []), s = [];
  if (a.entities.length) {
    const c = Je(a.areas, "area_id"), o = Je(a.devices, "id");
    for (const l of a.entities) {
      if (l.disabled_by || l.hidden_by || !e.states[l.entity_id] || !Et(l, t, !1)) continue;
      const d = K(l.entity_id);
      if (n.has($(d)) || i.length && !i.includes(d) || !we(l.entity_id, t)) continue;
      const p = l.device_id ? o.get(l.device_id) : void 0;
      if (p?.disabled_by) continue;
      const u = l.area_id || p?.area_id || void 0;
      if (!u) continue;
      const g = c.get(u), v = g?.name ?? u;
      if (r.size && !r.has($(u)) && !r.has($(v)))
        continue;
      const k = Ht(l.labels, p?.labels, g?.labels);
      Pt(k, t, a.labels) && s.push({
        entity: l.entity_id,
        area: v,
        domain: d
      });
  ...
  for (const [c, o] of Object.entries(e.states)) {
    const l = K(c);
    if (n.has($(l)) || i.length && !i.includes(l) || !we(c, t)) continue;
...
function vi(t, e, a, i) {
  const n = a?.states[t.entity], r = i.entities.find(
    (W) => W.entity_id === t.entity
  ), s = Ai(t.entity, e);
  if (r?.disabled_by || r?.hidden_by || r && !Et(r, e, s))
    return;
  const c = r?.device_id ? i.devices.find((W) => W.id === r.device_id) : void 0;
  if (c?.disabled_by) return;
  const o = t.area ? void 0 : r?.area_id || c?.area_id || void 0, l = t.area ?? ki(o, i) ?? z(n?.attributes?.area) ?? z(n?.attributes?.area_id);
  if (e.areas?.length && (!l || !$i(l, o, e.areas)))
    return;
  const d = t.domain ?? K(t.entity);
  if (!fi(t.entity, d, e)) return;
  const p = Ht(
    r?.labels,
    c?.labels,
    o ? i.areas.find((W) => W.area_id === o)?.labels : void 0
  ), u = n ? a?.formatEntityName?.(n) : void 0, g = n?.attributes?.friendly_name, v = H(t.name, t.entity), k = H(r?.name, t.entity) ?? H(r?.original_name, t.entity), w = H(c?.name_by_user, t.entity) ?? H(c?.name, t.entity), m = H(u, t.entity), y = H(g, t.entity), C = St(t.entity), Ee = Dt(
    C,
    t.entity
  ), ta = v ?? Ci(m ?? y ?? k ?? (Ee && w ? w : Ee ? "רכיב ללא שם" : C), w, t.entity, d);
  return {
    entity_id: t.entity,
    name: ta,
    area: l,
...
function fi(t, e, a) {
  return a.domains?.length && !N(a.domains).has($(e)) || N(a.exclude_domains ?? []).has($(e)) ? !1 : we(t, a);
}
function we(t, e) {
  ...
  return !(a.length && !a.some((n) => Xe(n).test(t)) || i.length && i.some((n) => Xe(n).test(t)));
}
function Et(t, e, a) {
  return a ? !0 : t.entity_category === "config" ? e.show_config_entities === !0 : t.entity_category === "diagnostic" ? e.show_diagnostic_entities === !0 : !0;
}
function Pt(t, e, a) {
  const i = zi(t, a), n = N(e.include_labels ?? []), r = N(e.exclude_labels ?? []);
...
async function yi(t) {
  ...
  if (e) return e;
  const a = Promise.all([
    ie(t, "config/area_registry/list"),
    ie(t, "config/device_registry/list"),
    ie(t, "config/entity_registry/list"),
    ie(t, "config/label_registry/list")
  ]).then(([i, n, r, s]) => ({
    areas: i.items,
    devices: n.items,
    entities: r.items,
...
function Ci(t, e, a, i) {
  if (!e || !t) return t;
  const n = $(t), r = $(e);
  return !n || !r || n.includes(r) || r.includes(n) ? t : i === "switch" && (Ri(t) || Mi(t) || t === St(a)) ? `${e} - ${t}` : t;
}
function Mi(t) {
  const e = t.trim();
...
async function Ii(t, e, a, i) {
  const { withAttributes: n, withoutAttributes: r } = Lt(e), s = await Promise.all([
    r.length ? tt(t, r, a, i, !0) : Promise.resolve({}),
    n.length ? tt(t, n, a, i, !1) : Promise.resolve({})
  ]);
  return Object.assign({}, ...s);
}
function Lt(t) {
  return {
    withAttributes: t.filter(et),
    withoutAttributes: t.filter((e) => !et(e))
  };
}
async function tt(t, e, a, i, n) {
...
function Ei(t, e) {
  ...
  if (Array.isArray(t))
    return t.forEach((i, n) => {
      ...
      const r = e[n], s = at(i, r), c = s[0]?.entity_id ?? r;
      c && (a[c] = s);
    }), a;
...
function at(t, e) {
  ...
  return t.map((i) => {
    ...
    const n = i, r = me(n.entity_id) ?? a;
    r && (a = r);
    const s = B(n.last_changed) ?? B(n.lc) ?? B(n.last_updated) ?? B(n.lu), c = me(n.state) ?? me(n.s);
    if (!r || !c || !s) return;
    const o = it(n.attributes) ?? it(n.a), l = {
      entity_id: r,
      state: c,
      last_changed: s
    };
    o && (l.attributes = o);
    const d = B(n.last_updated) ?? B(n.lu);
...
function B(t) {
  ...
  const e = t < 1e12 ? t * 1e3 : t, a = new Date(e);
  return Number.isNaN(a.getTime()) ? void 0 : a.toISOString();
}
function it(t) {
  return t && typeof t == "object" && !Array.isArray(t) ? t : void 0;
}
function nt(t, e, a, i, n = {}) {
  return e.map((r) => {
    const s = Pi(
      t[r.entity_id] ?? [],
      n[r.entity_id],
    ...
    ), c = Li(s), o = Di(c, r, a, i), l = o.filter((d) => d.active);
    return {
      entity: r,
      segments: o,
...
function Hi(t, e, a) {
  ...
  const i = t.domain || K(t.entity_id), r = t.config?.active_states ?? $a[i] ?? ["on"], s = t.config?.active_attributes ?? za[i] ?? {};
  ...
  for (const [o, l] of Object.entries(s)) {
    ...
    if (typeof d == "string" && l.includes(d))
      return { category: be(i, d), active: !0 };
  }
  const c = r.includes(e);
  return { category: be(i, e), active: c };
}
function Di(t, e, a, i) {
  if (!t.length) return [];
  ...
  for (let o = 0; o < t.length; o += 1) {
    const l = t[o];
    if (!l) continue;
    const d = t[o + 1], p = new Date(l.last_changed).getTime(), u = d ? new Date(d.last_changed).getTime() : s, g = Math.max(p, r), v = Math.min(u, s);
    if (v <= g) continue;
    const k = Hi(
      e,
      l.state,
  ...
  return Ni(n, i.merge_gap_seconds ?? 0).filter(
...
function Li(t) {
  ...
  for (const a of t) {
    const i = e.at(-1);
    i && i.state === a.state && rt(i) === rt(a) || e.push(a);
  }
  return e;
}
function rt(t) {
...
function Bi(t, e) {
  ...
  for (const n of Nt(e)) {
    const r = [
      ve(n.entity_id, "off", t.start.getTime(), void 0)
    ];
...
function Nt(t) {
  return t === "mockup05_visual" ? [] : t === "large_noisy_home" ? [...ke, ...Gi()] : t === "area_inventory" ? Oi() : t === "clean_activity_dashboard" ? ji() : ke;
}
function Oi() {
  return [
    ...ke.slice(0, 6),
...
function Ui(t, e, a = 320, i = 220) {
  ...
  const n = 16, r = t.left + t.width / 2 - a / 2, s = t.top + t.height + 12, c = st(r, n, e.width - a - n), o = st(s, n, e.height - i - n);
...
function Vi(t) {
  ...
  if (!t.live) return !1;
  const e = Ft(t.refreshIntervalSeconds) * 1e3;
...
function Bt(t, e = {}) {
  if (!t.groups.length) return dn();
  const a = { ...e, nowPercent: t.nowPercent }, i = e.openInventoryGroupId ? t.groups.find((n) => n.id === e.openInventoryGroupId) : void 0;
  return h`
    <section
      class="ahc-dashboard"
      dir="rtl"
...
function an(t) {
  return t.aggregateSegments.length > 0 || t.rows.some((e) => e.segments.length > 0);
}
function nn(t, e = [], a = {}) {
  const i = t.expandedInventory === !0, n = t.rows.length > 0, r = an(t), s = t.inventoryItems.length > 0, c = t.rows, o = i && s;
  return h`
    <section
      class="ahc-area-lane ahc-area-lane--active ahc-area-card ahc-dashboard-group"
      data-has-activity=${r ? "true" : "false"}
    ...
    >
      ...
      ${r || t.aggregateSegments.length ? h`<div
  ...
  return h`
    <div class="ahc-lane-row ahc-dashboard-row" dir="rtl">
      <div class="ahc-lane-row__label ahc-dashboard-row__label" dir="rtl">
        ${de(t.icon, "ahc-dashboard-row__label-icon")}
...
function Ot(t, e) {
  ...
  return h`
    ...
    >
      ${de(t.icon, "ahc-inventory-chip__icon")}
...
function Gt(t, e, a, i, n) {
  return h`
    <div class=${`ahc-timegrid ahc-timegrid--${e}`} dir="ltr">
      ${Ut(t)}
      ${i?.show_now_line === !1 ? _ : Vt(t, "line", n)}
  ...
  return h`
    ...
    (i) => h`
              <span
                ...
                data-edge=${_n(i.percent)}
                style=${`left:${i.percent}%`}
                >${i.label}</span
              >
            `
  )}
        ${e?.show_now_line === !1 ? _ : Vt(t, "label", a)}
      </div>
    </div>
  `;
}
function Ut(t) {
  const e = t.length ? t : pn();
  return h`
...
const F = 60 * 60 * 1e3, gn = [1, 2, 3, 4, 6, 8, 12, 24], mn = [6, 12, 24, 48, 72, 96, 168];
function bn(t, e = {}) {
  const a = Cn(e.maxMajorTicks ?? 8, 2, 10), i = vn(t, a), r = [...$n(t, i.stepMs, i.ticks), ...i.ticks].sort(
...
function vn(t, e) {
  const i = Math.max(1, t.end.getTime() - t.start.getTime()) / F, n = fn(i, e), r = [
    t.start,
    ...qt(t, n),
    t.end
  ];
...
function fn(t, e) {
  const a = t <= 30 ? gn : t <= 96 ? mn : [24, 48, 72, 96, 168, 336], i = Math.max(0, e - 2);
  for (const n of a)
...
function qt(t, e) {
  ...
  for (let r = yn(t.start, e); r.getTime() < i; r = xn(r, e))
...
function yn(t, e) {
  ...
  if (a >= 24 && a % 24 === 0) {
    ...
    for (s.setHours(0, 0, 0, 0), s.getTime() <= t.getTime() && s.setDate(s.getDate() + 1); wn(s) % r !== 0; )
...
function $n(t, e, a) {
  ...
  return qt(t, i).filter((r) => !n.has(Math.round(r.getTime() / 1e3))).map((r) => ({
    time: r,
    label: "",
    percent: I(r, t),
    major: !1
...
function zn(t) {
  return t <= 48 ? f : (e) => new Intl.DateTimeFormat("he-IL", {
    day: "2-digit",
    month: "2-digit"
  }).format(e);
}
...
function Mn(t) {
  return Bt(
    $e(t.model, t.config, t),
    Sn(t)
  );
}
function $e(t, e, a = {}) {
  const i = Rn(t.range, e), n = t.groups.map((s) => En(s, t, e, a)).filter((s) => !!s), r = Tn(t);
  return {
    hero: {
      ...S.hero,
      subtitle: `Home Assistant · ${ht(t.range)} · ${t.totalInventoryItemCount} רכיבים`
    },
    toolbar: S.toolbar,
    summary: r,
    rangeLabel: ht(t.range),
    axisLabels: i.labels,
    nowPercent: i.nowPercent,
    density: In(t.densityBuckets),
    groups: n,
    insights: Dn(t)
  };
}
function Rn(t, e = { type: "custom:activity-history-card" }, a = /* @__PURE__ */ new Date()) {
  const i = bn(t, {
    maxMajorTicks: jn(e),
    now: a
  });
...
function Tn(t) {
  const e = Ln(t.groups), a = e ? [
    Yt(e.segment.category),
    e.row.area,
    f(e.segment.end)
  ...
  return [
    ...
    },
    {
      id: "component-hours",
      label: "סה״כ שעות־רכיב",
      value: x(t.totalVisibleActiveMs),
      caption: "סכום פעילות על פני כל הרכיבים",
      icon: "mdi:clock-outline",
      tone: "heating"
    },
    {
      ...
      tone: e ? Ie(e.segment.category) : "idle"
    }
  ];
}
function In(t) {
  return t.length ? t.map((e, a) => ({
    id: `density-${a}`,
    label: f(e.start),
    value: `${x(e.totalActiveMs)} · ${e.activeEntityCount} רכיבים`,
...
function En(t, e, a, i) {
  const n = a.show_area_inventory !== !1 && a.area_inventory_mode !== "off", r = t.activityRows.length > 0, s = t.activityRows.some((v) => v.segments.length > 0) || t.aggregateSegments.length > 0 || t.totalActiveMs > 0, c = n && t.inventoryItems.length > 0;
  if (!r && !s && !c) return;
  const o = a.area_inventory_mode === "expanded" || e.singleAreaFocused || i.showAllInventory === !0, l = i.collapsedInventoryGroups?.has(t.id) === !0 ? !1 : o || i.expandedInventoryGroups?.has(t.id) === !0, d = c ? t.inventoryItems.map(Hn) : [], p = Bn(a), u = l ? d.length : Math.min(4, p, d.length), g = Math.max(
    0,
    t.inventoryItemCount - u
  );
  return {
    id: t.id,
    title: t.title,
    icon: t.icon ?? "mdi:home-outline",
    meta: `${t.inventoryItemCount} רכיבים · ${x(t.totalActiveMs)}`,
    activityLabel: s ? `${t.visibleActivityRowCount} פעילים · ${t.eventCount} אירועים` : "אין פעילות בטווח",
    inventoryLabel: "כל האביזרים",
    aggregateSegments: t.aggregateSegments.map(Kt),
    rows: t.activityRows.map(Pn),
    inventoryItems: d,
    inventoryTotal: t.inventoryItemCount,
    hiddenInventoryCount: g,
    expandedInventory: l
  };
}
function Pn(t) {
  const e = Nn(t), a = e ? Ie(e.category) : t.activeNow ? "on" : "idle";
  return {
    id: t.entityId,
    entityId: t.entityId,
    label: t.name,
    secondary: t.secondary,
    state: e ? Yt(e.category) : t.activeNow ? "פעיל" : "לא פעיל",
    stateTone: a,
    icon: t.icon ?? Xt(t.domain),
    totalLabel: x(t.totalActiveMs),
    eventLabel: `${t.eventCount} אירועים`,
    segments: t.segments.map(Kt)
  };
}
function Kt(t) {
  return {
...
function Hn(t) {
  return {
    ...
    entityId: t.entityId,
    label: t.name,
    secondary: dt(t.domain),
    state: t.currentStateLabel ?? dt(t.domain),
    stateTone: Fn(t),
    icon: t.icon ?? Xt(t.domain),
  ...
  return [
    {
      ...
      caption: e ? `${e.secondary ?? "רכיב"} · ${x(e.totalActiveMs)} · ${e.eventCount} אירועים` : "לא נמצאה פעילות בטווח הנוכחי",
      icon: "mdi:star-four-points"
    },
    {
      id: "most-active-area",
      ...
      caption: a ? `${a.rowCount} רכיבים · ${x(a.totalActiveMs)} · ${a.eventCount} אירועים` : "לא נמצאו אזורים פעילים",
      icon: "mdi:home-lightning-bolt-outline"
    },
    {
      id: "peak-hours",
...
function Ie(t) {
  return t === "off" || t === "idle" ? "idle" : t === "unknown" || t === "unavailable" ? "unavailable" : Wt(t);
}
function Fn(t) {
  return t.stateTone === "unavailable" ? "unavailable" : t.currentCategory ? Ie(t.currentCategory) : t.activeNow ? "on" : (t.hadActivityInRange, "idle");
}
function Yt(t) {
  return A[t] ?? t;
}
...
function ht(t) {
  ...
  return `${ze(t.start, t, e)} - ${ze(t.end, t, e)} · ${On(a)}`;
}
function On(t) {
...
function ze(t, e, a) {
  return fe(t, e.end) && Gn(e, a) ? "עכשיו" : Math.max(
    1,
    (e.end.getTime() - e.start.getTime()) / 36e5
  ) > 48 ? new Intl.DateTimeFormat("he-IL", {
    day: "2-digit",
    month: "2-digit"
  }).format(t) : Un(e.start, e.end) && (fe(t, e.start) || fe(t, e.end)) ? new Intl.DateTimeFormat("he-IL", {
    day: "2-digit",
    month: "2-digit",
    hour: "2-digit",
    minute: "2-digit"
...
function qn(t) {
  ...
  const e = t.domain || K(t.entity_id);
  return Jt[e] ?? "mdi:circle-medium";
}
function Kn(t) {
  if (t.icon?.startsWith("mdi:") || t.icon && !t.icon.includes(":")) return t.icon;
  const e = Jt[t.id];
  return e || (Vn.find(([i]) => i.test(t.title))?.[1] ?? "mdi:home-outline");
}
function Zt(t, e) {
  return t.startsWith("mdi:") ? h`<ha-icon class=${e} icon=${t}></ha-icon>` : h`<span class=${e} aria-hidden="true">${t}</span>`;
}
function Qt(t, e = "ahc-entity-icon") {
  return Zt(qn(t), e);
}
function ea(t, e = "ahc-group-icon") {
  return Zt(Kn(t), e);
}
function Wn(t) {
  const e = Yn(
    ...
    t.range,
    t.config
  ), a = tr(t.range), i = U(t.curation), n = ar(t.range);
  return e.visibleRowCount ? h`
    <section class="ahc-activity" aria-label="ציר זמן פעילות">
      ...
      ${t.config.show_activity_density === !1 ? null : Zn(e.density)}
...
function Yn(t, e, a) {
  const i = t.map((c) => {
    const o = c.rows.filter(er), l = o.reduce(
    ...
    <article class="ahc-activity-group" aria-label=${t.title}>
      <header class="ahc-activity-group__header">
        <span class="ahc-activity-group__title">
          ${ea(t)}<strong>${t.title}</strong>
        </span>
        <span class="ahc-activity-group__meta">
          ${t.rows.length} רכיבים · ${x(t.totalActiveMs)}
        </span>
      </header>
      <div class="ahc-activity-group__rows">
        ${t.rows.map((i) => Jn(i, e, a))}
      </div>
    </article>
  `;
}
function Jn(t, e, a) {
  return h`
    ...
    const s = `${t.entity.name}, ${A[i.category]}, ${f(i.start)} עד ${f(i.end)}, ${x(
      i.durationMs
    )}`;
    return h`
            <button
...
function tr(t) {
  ...
  return i.push({ label: f(t.end), percent: 100 }), i;
}
function ar(t) {
  const e = Math.round(
    (t.end.getTime() - t.start.getTime()) / 36e5
...
function ir(t) {
  ...
  ), a = or(t.range), i = U(t.curation), n = /* @__PURE__ */ new Date(), r = I(n, t.range), s = t.config.show_inactive_baselines === !0, c = t.config.show_now_line !== !1 && n.getTime() >= t.range.start.getTime() && n.getTime() <= t.range.end.getTime() + 9e4;
  return h`
    <section
    ...
    return h`
      ...
      (d) => h`
        ...
        if (!rr(
          ...
          return null;
        const w = `${d.entity.name}, ${A[p.category]}, ${f(p.start)} עד ${f(p.end)}, ${x(p.durationMs)}`;
        return h`
                                <rect
      ...
      ${t.config.show_legend === !1 ? null : sr()}
    </section>
  `;
}
function nr(t, e) {
...
class dr extends G {
  constructor() {
    ...
    }, this._areas = [], this._labels = [], this._domains = re, this._loadedOptions = !1;
  }
  static {
    this.styles = gt`
    :host {
  ...
  render() {
    const e = this._config, a = e.domains?.length ? e.domains : re;
    return h`
      <div class="editor">
  ...
  async _loadOptions() {
    ...
    const [e, a] = await Promise.all([
      ...
      ...new Set(Object.keys(this._hass.states).map(K))
    ].filter(Boolean).sort();
...
class hr extends G {
  constructor() {
    super(...arguments), this._rows = [], this._visibleRows = [], this._groups = [], this._loading = !1, this._fullscreen = !1, this._filterSheetOpen = !1, this._usingMockData = !1, this._showAllRows = !1, this._debugLegacyView = !1, this._expandedInventoryGroups = /* @__PURE__ */ new Set(), this._collapsedInventoryGroups = /* @__PURE__ */ new Set(), this._fetchToken = 0, this._lastFetchKey = "", this._hasFetchedOnce = !1, this._initialLoad = !1, this._backgroundLoading = !1, this._lastResolvedEntityKey = "", this._lastHistoryFetchAt = 0, this._historyCache = /* @__PURE__ */ new Map(), this._filter = {
      ...
      if (!n || !r || !s) return;
      const c = s.getBoundingClientRect(), o = Ui(c, {
  ...
  render() {
    ...
    const e = this._hass?.locale?.language ?? this._hass?.language, a = Ua(
  ...
  _renderLastEventPill() {
    ...
    return !a || !i ? _ : h`
      <div class="ahc-last-event">
        ...
        <span
          >${f(i.start)} · ${A[i.category]} ·
          ${_e(a, this._config.debug === !0)}</span
        >
      </div>
    `;
  }
  _renderFilters() {
    ...
    if (this._isMockup05VisualPreview())
      return en(S.toolbar);
    const e = U(this._curation), i = this._currentRendererMode() === "activity", n = !!(i ? this._canToggleAreaInventory() : this._curation?.hiddenRows || this._showAllRows), r = i ? this._showAllRows ? "פעילות בלבד" : "כל האביזרים" : this._showAllRows ? "הצג רק פעילות" : "הצג הכל";
    return h`
  ...
  _renderSummary() {
    ...
    if (this._dashboardModel && this._config.summary_scope !== "all")
      return ot(
        $e(this._dashboardModel, this._config, {
      ...
      >
        <article class="ahc__metric">
          <div class="ahc__metric-copy">
            ...
            >
            <span class="ahc__metric-subtitle">
              ${i && a ? `${f(i.start)} · ${A[i.category]} · ${_e(a, this._config.debug === !0)}` : "לא נמצאו אירועים בטווח"}
            </span>
          </div>
          <span class="ahc__metric-icon" aria-hidden="true">♪</span>
        </article>
    ...
    switch (this._currentRendererMode()) {
      ...
      case "legacy_swimlane":
        return h`
          ...
          summary: this._summary ?? j(this._groups),
      ...
      default:
        return Mn({
          model: this._dashboardModel ?? We(
            this._groups,
            a,
            this._config,
            this._curation,
            {
              inventoryRows: Ze(this._rows, this._filter),
...
show_inactive_baselines: true`
      ...
      <section class="ahc__insights" aria-label="תובנות חכמות">
        ...
        <article class="ahc__insight-card">
          ...
          <span class="ahc__insight-subtitle"
            >${a ? `${x(a.totalActiveMs)} · ${_e(a, this._config.debug === !0)}` : "צריך היסטוריה פעילה בטווח"}</span
          >
        </article>
        <article class="ahc__insight-card">
          ...
          >
          <span class="ahc__insight-subtitle"
            >${i ? `${x(i.totalActiveMs)} · ${i.subtitle ?? ""}` : "אין אזור עם פעילות משמעותית"}</span
          >
        </article>
        <article class="ahc__insight-card">
    ...
    return h`
      ...
      a.mostActiveEntity.totalActiveMs
        ...
        <article class="ahc__insight-card">
          ...
          <span class="ahc__insight-subtitle">
            ${a.mostActiveArea ? `${x(a.mostActiveArea.totalActiveMs)} · ${a.mostActiveArea.rowCount} רכיבי פעילות מתוך ${a.mostActiveArea.inventoryCount} אביזרים` : "אין אזור עם פעילות משמעותית"}
          </span>
        </article>
        <article class="ahc__insight-card">
          <span class="ahc__insight-kicker">שעות שיא</span>
      ...
      (n) => this._renderChip(
        ...
        <div class="ahc-filter-section">
          ...
          >
            ...
            <small
              >${U(this._curation) || "הסתר שורות ריקות, טכניות וקצרות מאוד"}</small
            >
          </button>
        </div>
  ...
  async _fetchAndRender(e, a) {
    ...
    const c = n ? {
      entities: Fi(this._config.mock_profile),
      diagnostics: void 0
    } : await mi(this._config, this._hass);
    if (r !== this._fetchToken) return;
    const o = c.entities, l = pr(o), d = this._resolveRange(), p = Lt(o), u = Ti({
      mock: n,
    ...
    }), g = a && ["manual", "timer", "interval", "config"].includes(e), k = !!(this._lastResolvedEntityKey && this._lastResolvedEntityKey !== l) && e === "interval" ? "entities" : e, w = (m, y, C = c.diagnostics) => {
    ...
    if (!o.length) {
      this._loadedRange = d, this._usingMockData = !1, this._rows = [], this._visibleRows = [], this._groups = [], this._dashboardModel = void 0, this._summary = j([]), this._curation = ae([], this._config).diagnostics, this._emptyReason = this._config.auto_discover === !1 && !this._config.entities?.length ? "no_entities_selected" : "no_resolved_entities", this._setDiagnostics({
    ...
    if (!g && u === this._lastFetchKey) {
      ...
      if (m) {
        ...
        this._rows = nt(
          ...
          this._config,
          this._hass?.states ?? {}
        ), w(!0, y), this._initialLoad = !1, this._loading = !1, this._backgroundLoading = !1, this._error = void 0, this._rebuildGroups();
        return;
      }
    }
    try {
      let m = g ? void 0 : this._historyCache.get(u);
      if (m || (m = n ? Bi(d, this._config.mock_profile) : await Ii(
        this._hass,
        o,
        d,
        this._config
      ...
      this._rows = nt(
        ...
        this._config,
        this._hass?.states ?? {}
      ), w(!1, y), this._lastFetchKey = u, this._rebuildGroups();
    } catch (m) {
      this._error = m instanceof Error ? m.message : String(m), this._rows.length || (this._visibleRows = [], this._groups = [], this._dashboardModel = void 0, this._summary = j([]), this._curation = ae([], this._config).diagnostics, this._emptyReason = void 0);
    } finally {
      r === this._fetchToken && (this._initialLoad = !1, this._loading = !1, this._backgroundLoading = !1, this.requestUpdate());
    }
  }
  _rebuildGroups() {
    const e = Ze(this._rows, this._filter), a = this._displayRange(), i = this._currentRendererMode(), n = i !== "activity" && this._showAllRows, r = ae(e, this._config, {
      showAll: n,
      groupBy: this._filter.groupBy
    }), s = i === "activity" ? ae(
      e,
      {
        ...
        hide_empty_rows: !1,
        show_inactive_baselines: !0,
        max_rows_per_group: pt,
        max_total_rows: pt
      },
      {
        groupBy: this._filter.groupBy
      }
    ) : r, c = i === "activity" ? s.rows : r.rows;
    this._visibleRows = c, this._curation = i === "activity" ? s.diagnostics : r.diagnostics;
    const o = i === "activity" ? s.rows : [
      ...r.rows,
      ...r.hiddenRows.filter(
        (d) => r.hiddenReasons.get(d.entity.entity_id) === "max_rows"
      )
    ], l = ge(
      o,
      this._filter.groupBy
    ).filter(
      (d) => this._config.hide_empty_groups === !1 || d.rows.length > 0
    );
    this._groups = ge(c, this._filter.groupBy).filter(
      (d) => this._config.hide_empty_groups === !1 || d.rows.length > 0
    ), this._dashboardModel = i === "activity" ? We(
      l,
      a,
      this._config,
      s.diagnostics,
      {
        ...
        includeInactiveRows: !0,
        inventoryRows: e,
        selectedAreas: this._filter.areas,
        groupBy: this._filter.groupBy
      }
    ) : void 0, this._summary = i === "activity" && this._dashboardModel && this._config.summary_scope !== "all" ? Za(this._dashboardModel) : j(
      this._config.summary_scope === "all" ? ge(e, this._filter.groupBy) : this._groups
    ), this._rows.length && !e.length ? this._emptyReason = "all_entities_filtered" : e.length && !c.length ? this._emptyReason = "no_meaningful_activity" : (this._emptyReason === "all_entities_filtered" || this._emptyReason === "no_meaningful_activity") && (this._emptyReason = void 0), this._diagnostics && this._setDiagnostics({
      ...this._diagnostics,
  ...
  _resolveRange() {
    ...
    return this._filter.timePreset === "24h" ? ue(
      {
        ...this._config,
        start_time: void 0,
  ...
  _currentRendererMode() {
    return this._config.debug && this._debugLegacyView ? "legacy_swimlane" : lr(this._config, this._showAllRows);
  }
...
customElements.get("activity-history-card") || customElements.define("activity-history-card", hr);
